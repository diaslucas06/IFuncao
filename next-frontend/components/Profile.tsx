        ...
        <>
            <div className="flex bg-(--primary-800) text-(--neutral-0) justify-center h-30 py-5 md:h-auto md:justify-start md:px-10 md:py-8 pc:px-15 pc:pt-15 pc:pb-10">
                ...
                <div className='hidden md:pl-60 lg:pl-70 lp:pl-75 pc:pl-95 md:flex md:flex-col'>
                    <h1 className="font-bold font-poppins-sans md:text-[32px] lg:text-4xl lp:text-[40px] pc:text-5xl">{props.usuario}</h1>
                    <p className="font-poppins-sans md:text-xl lg:text-2xl lp:text-[28px] pc:text-[32px]">{props.ano}° ano, {props.curso}</p>
                    <p className="font-poppins-sans md:text-xl lg:text-2xl lp:text-[28px] pc:text-[32px]">{props.matricula}, {props.idade} anos</p>
                </div> 
            </div>
            <div className='flex flex-col items-center pt-18 md:pl-60 lg:pl-70 lp:pl-75 pc:pl-95 md:hidden'>
                ...
                <p className="font-poppins-sans text-base">{props.ano}° ano, {props.curso}</p>
                <p className="font-poppins-sans text-base">{props.matricula}, {props.idade} anos</p>
            </div> 
        </>
    )
}